...
typedef struct {
    ...
    char* name;
    uint8_t (*calc_att)(netstats_peer_t*); /**< Calculate transmit attenuation */
    uint8_t (*callback)(netstats_peer_t*, uint8_t, uint8_t); /**< Callback from a succesful transmit */
    void (*reset)(netstats_peer_t*);    /**< resets the OF */
