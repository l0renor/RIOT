 ...
 * DELAY INTERFACE
 *********************/
#define LV_DRV_DELAY_INCLUDE  "xtimer.h"            /*Delay header (Dummy include by default)*/
#define LV_DRV_DELAY_US(us)   xtimer_usleep(us)         /*Delay the given number of microseconds*/
#define LV_DRV_DELAY_MS(ms)   xtimer_usleep(ms * US_PER_MS)       /*Delay the given number of milliseconds*/
 ...
 *  Common
 *------------*/
#define LV_DRV_DISP_INCLUDE         "xtimer.h"           /*Driver header (Dummy include by default)*/
